...
* NODE-606 better error handling on destroyed topology for user-model.js methods.
...
* Added db(dbName) method to user-model.js to allow for reuse of connections against other databases
